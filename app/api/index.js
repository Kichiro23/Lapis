...
app.get('/api/scholarships', (req, res) => {
  const scholarships = [
    ...
    },
    {
      ...
      description: 'UK government scholarship for outstanding emerging leaders to pursue a one-year master\'s degree in the UK.',
      gwaReq: 2.0,
      incomeReq: 'None specified',
      courses: ['Any one-year master\'s program'],
      requirements: ['Bachelor\'s degree', '2+ years work experience', 'Leadership potential', 'English proficiency'],
      benefits: ['Full university tuition', 'Monthly living stipend', 'Return flights to UK', 'Arrival allowance', 'Thesis grant'],
      process: ['Online application', 'Essays on leadership and networking', 'References', 'Interview at British embassy'],
    ...
    },
    {
      ...
      description: 'US government scholarship for graduate students and young professionals to study in the United States.',
      gwaReq: 2.0,
      incomeReq: 'None specified',
      courses: ['Any graduate program'],
      requirements: ['Bachelor\'s degree', 'English proficiency (TOEFL/IELTS)', 'Academic excellence', 'Community involvement'],
      benefits: ['Full tuition', 'Monthly stipend', 'Health insurance', 'Airfare', 'J-1 visa sponsorship'],
      process: ['Application through US embassy/commission', 'Personal statement', 'References', 'Interview', 'Final selection'],
      link: 'https://fulbright.state.gov',
    },
    {
      id: 'erasmus',
      name: 'Erasmus Mundus Joint Master\'s (EU)',
      type: 'International',
      amount: '€1,400/month + tuition waiver + travel',
      deadline: 'January 15, 2027',
      description: 'EU-funded scholarships for students to study in multiple European universities within a joint master\'s program.',
      gwaReq: 2.0,
      incomeReq: 'None specified',
      courses: ['Various joint master\'s programs'],
      requirements: ['Bachelor\'s degree', 'English proficiency', 'Motivation letter', 'References'],
      benefits: ['Monthly allowance €1,400', 'Tuition waiver', 'Travel allowance', 'Installation costs', 'Visa support'],
      process: ['Apply to specific Erasmus program', 'Submit documents', 'Program selection committee review', 'Notification'],
    ...
    },
    {
      ...
      gwaReq: 2.0,
      incomeReq: 'Varies by country',
      courses: ['Any development-related course'],
      requirements: ['Citizen of eligible country', 'Bachelor\'s degree', 'English proficiency', 'Return to home country'],
      benefits: ['Full tuition', 'Living allowance', 'Travel costs', 'Health insurance', 'Pre-departure training'],
      process: ['Online application', 'Document submission', 'Interview', 'Final selection'],
    ...
    },
    {
      ...
      gwaReq: 2.0,
      incomeReq: 'None specified',
      courses: ['Master\'s and PhD programs'],
      requirements: ['Bachelor\'s degree', 'English or German proficiency', 'Academic excellence', 'Motivation letter'],
      benefits: ['Monthly stipend', 'Health insurance', 'Travel allowance', 'Study and research grant'],
      process: ['Apply through DAAD portal', 'University admission letter', 'Reference letters', 'Interview'],
    ...
    },
    {
      ...
      description: 'Full-cost scholarship at the University of Cambridge for outstanding applicants from countries outside the UK.',
      gwaReq: 1.0,
      incomeReq: 'None specified',
      courses: ['Any PhD or master\'s at Cambridge'],
      requirements: ['Outstanding intellectual ability', 'Leadership capacity', 'Commitment to improving lives', 'Cambridge admission'],
      benefits: ['Full tuition', 'Maintenance allowance', 'Airfare', 'Visa costs', 'Academic development funding'],
      process: ['Apply to Cambridge degree', 'Gates Cambridge statement', 'References', 'Interview'],
      link: 'https://www.gatescambridge.org',
    },
    {
      id: 'japan-jasso',
      name: 'JASSO Student Exchange Support (Japan)',
      type: 'International',
      amount: '¥80,000/month',
      deadline: 'December 1, 2026',
      description: 'Japan Student Services Organization scholarship for international students studying at Japanese universities.',
      gwaReq: 2.5,
      incomeReq: '¥3,000,000/year household',
      courses: ['Any course at Japanese university'],
      requirements: ['Enrolled at Japanese university', 'Good academic standing', 'Financial need', 'Student visa'],
      benefits: ['Monthly stipend ¥80,000', 'Travel allowance', 'Japanese language support'],
      process: ['Apply through university', 'Document submission', 'Screening', 'Notification'],
    ...
    },
    {
      ...
      type: 'International',
      amount: 'Full tuition + monthly stipend + Korean language training',
      deadline: 'February 28, 2027',
      description: 'Korean government scholarship for international students to pursue undergraduate or graduate degrees in Korea.',
      gwaReq: 2.0,
      incomeReq: 'None specified',
      courses: ['Any course at Korean university'],
      requirements: ['Non-Korean citizen', 'Bachelor\'s (for grad) or high school diploma', 'Health certificate', 'Language proficiency'],
      benefits: ['Full tuition', 'Monthly stipend', 'Airfare', 'Medical insurance', 'Korean language training'],
      process: ['Embassy or university track application', 'Document screening', 'Interview', 'Medical exam', 'Final selection'],
    ...
    },
    {
      ...
      description: 'Scholarships for students from Commonwealth countries to pursue master\'s and PhD in the UK.',
      gwaReq: 2.0,
      incomeReq: 'None specified',
      courses: ['Development-related courses'],
      requirements: ['Commonwealth citizen', 'Bachelor\'s degree', 'Academic merit', 'Development impact potential'],
      benefits: ['Full tuition', 'Living allowance', 'Travel', 'Thesis grant', 'Family allowance'],
      process: ['Apply through nominating agency', 'Online application', 'References', 'Selection panel review'],
    ...
    },
    {
      ...
      type: 'International',
      amount: 'Full tuition + monthly stipend + housing',
      deadline: 'February 20, 2027',
      description: 'Turkish government scholarship for international students at all levels in Turkish universities.',
      gwaReq: 2.5,
      incomeReq: 'None specified',
      courses: ['Any course at Turkish university'],
      requirements: ['Non-Turkish citizen', 'Academic transcript', 'Research proposal (for grad)', 'Health certificate'],
      benefits: ['Full tuition', 'Monthly stipend', 'Accommodation', 'Flight ticket', 'Health insurance', 'Turkish language course'],
      process: ['Online application', 'Document review', 'Interview', 'Final selection'],
      link: 'https://www.turkiyeburslari.gov.tr',
    },
    {
      id: 'singapore-scholarship',
      name: 'Singapore International Graduate Award (SINGA)',
      type: 'International',
      amount: 'Full tuition + S$2,200/month + airfare',
      deadline: 'June 1, 2027',
      description: 'Award for outstanding international graduates to pursue PhD at top Singapore universities.',
      gwaReq: 1.5,
      incomeReq: 'None specified',
      courses: ['Science and Engineering PhD'],
      requirements: ['Bachelor\'s or master\'s degree', 'English proficiency', 'Strong academic record', 'Research interest alignment'],
      benefits: ['Full tuition', 'Monthly stipend S$2,200', 'Airfare', 'Settling-in allowance', 'Conference funding'],
      process: ['Online application', 'Submit research proposal', 'References', 'Interview', 'Admission'],
